...
function buildTEGeometries(L, W, H, nT, decals, manuL, manuW, manuH, dims) {
  ...
  const topCoverHoles = getPanelWindowHoles("p3_top_cover", decals, topCoverShape, L, W, H, manuL, manuW, manuH, dims, nT);
  ...
  const topLipHoles = getPanelWindowHoles("p3_top_lip", decals, topLipShape, L, W, H, manuL, manuW, manuH, dims, nT);
  ...
  const topDustP2Shape = createDustP4Shape();
  ...
  const botDustP2Shape = createDustP2Shape(); 
  ...
  const topDustP4Shape = createDustP2Shape();
  ...
  const botDustP4Shape = createDustP4Shape();
      ...
      <group position={[L / 2, 0, 0]} rotation={[0, tubeAngle, 0]}>
        ...
        <group position={[W, 0, 0]} rotation={[0, tubeAngle, 0]}>
          ...
          <group position={[L / 2, H / 2, -nT]} rotation={[-ttAngle, 0, 0]}>
            <mesh geometry={geoms.topCoverGeom} material={flap}>{D("p3_top_cover")}</mesh>
