...
export default function CinematicAbout() {
  ...
  return (
    <div ref={container} className="relative w-full bg-transparent text-[#09090b] font-sans antialiased overflow-hidden selection:bg-[#B8956A]/20 selection:text-[#09090b]">
      <div ref={scrollWrapper} className="relative w-full h-screen overflow-hidden z-10">

        {/* ── SCENE 1: Plain Box Hero ─────────────────────────────────── */}
        <div className="scene-1-wrapper absolute inset-0 flex items-center justify-center px-16">
          <div className="flex items-center justify-center gap-16 max-w-6xl w-full">
            <div className="w-[450px] h-[450px] max-w-[45vw] max-h-[50vh] flex-shrink-0">
              <GLBModel src="/box.glb" className="w-full h-full" autoRotateSpeed={2} cameraDistance={3.2} />
            </div>
            <div className="max-w-lg">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#B8956A]/10 border border-[#B8956A]/30 text-[#9A7446] text-xs font-bold mb-6 uppercase tracking-widest">
                ✦ About Keyline Design Studio
              </span>
              <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6 uppercase leading-tight text-[#09090b]">
        ...
        <div className="scene-3-wrapper absolute inset-0 flex items-center justify-center px-12 opacity-0">
          <div className="grid grid-cols-3 gap-8 max-w-7xl w-full items-center">
            <div className="scene-3-left space-y-6 opacity-0">
              <div className="bg-white/80 border border-slate-200/80 rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.04)] backdrop-blur-md">
                <h3 className="text-lg font-bold text-[#09090b] mb-1.5">Real-Time 3D Assembly</h3>
                <p className="text-[#64748b] text-sm leading-relaxed">Instant 3D folding animation lets you inspect box closures, dust flaps, and tuck tabs from every angle.</p>
              </div>
              <div className="bg-white/80 border border-slate-200/80 rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.04)] backdrop-blur-md">
                <h3 className="text-lg font-bold text-[#09090b] mb-1.5">Parametric Dieline Generator</h3>
                <p className="text-[#64748b] text-sm leading-relaxed">Customize Width, Depth, and Height in millimeters. Our geometry engine recalculates crease lines and glue flaps live.</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <div className="w-full flex items-center justify-center" style={{ height: "55vh" }}>
              ...
              <div className="scene-3-label text-center mt-2 opacity-0">
                <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#B8956A]/10 border border-[#B8956A]/30 text-[#9A7446] text-xs font-bold uppercase tracking-widest mb-2">
                  ✦ Dynamic Library
                </span>
                <h2 className="text-3xl font-black tracking-tight uppercase text-[#09090b]">Versatility</h2>
                <p className="text-[#64748b] text-sm mt-1">Beyond boxes — bottles, cans, pouches, and more.</p>
              </div>
            </div>
            <div className="scene-3-right space-y-6 opacity-0">
              <div className="bg-white/80 border border-slate-200/80 rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.04)] backdrop-blur-md">
                <h3 className="text-lg font-bold text-[#09090b] mb-1.5">Realistic Material Shaders</h3>
                <p className="text-[#64748b] text-sm leading-relaxed">Switch between kraft cardboard, matte fiber, gloss, metallic foil, and custom color finishes.</p>
              </div>
              <div className="bg-white/80 border border-slate-200/80 rounded-2xl p-5 shadow-[0_4px_20px_rgba(0,0,0,0.04)] backdrop-blur-md">
                <h3 className="text-lg font-bold text-[#09090b] mb-1.5">Production PDF &amp; SVG Export</h3>
                <p className="text-[#64748b] text-sm leading-relaxed">Export vector dielines compatible with Illustrator, CAD, and laser cutting machines without resolution loss.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="scene-4-wrapper absolute inset-0 flex items-center justify-center opacity-0 overflow-hidden">
          ...
          <div className="scene-4-left absolute left-12 md:left-24 max-w-xs space-y-6 z-10 pointer-events-none opacity-0">
            <div className="bg-white/85 border border-slate-200/80 rounded-2xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur-md">
              <div className="text-3xl md:text-5xl font-black text-[#B8956A] mb-1 tracking-tight">50,000+</div>
              <div className="text-sm font-bold text-[#09090b] uppercase tracking-wider mb-1">Dielines Generated</div>
              <p className="text-[#64748b] text-xs">Print-ready structural vector files</p>
            </div>
            <div className="bg-white/85 border border-slate-200/80 rounded-2xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur-md">
              <div className="text-3xl md:text-5xl font-black text-[#B8956A] mb-1 tracking-tight">15,000+</div>
              <div className="text-sm font-bold text-[#09090b] uppercase tracking-wider mb-1">Active Brands &amp; Agencies</div>
              <p className="text-[#64748b] text-xs">Worldwide design professionals</p>
            </div>
            <div className="bg-white/85 border border-slate-200/80 rounded-2xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur-md">
              <div className="text-3xl md:text-5xl font-black text-[#B8956A] mb-1 tracking-tight">99.8%</div>
              <div className="text-sm font-bold text-[#09090b] uppercase tracking-wider mb-1">Print Accuracy</div>
              <p className="text-[#64748b] text-xs">Verified structural tolerances</p>
            </div>
          </div>
          <div className="scene-4-right absolute right-12 md:right-24 max-w-xs space-y-6 z-10 pointer-events-none opacity-0 text-right">
            <div className="bg-white/85 border border-slate-200/80 rounded-2xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur-md">
              <div className="text-3xl md:text-5xl font-black text-[#B8956A] mb-1 tracking-tight">120+</div>
              <div className="text-sm font-bold text-[#09090b] uppercase tracking-wider mb-1">Box &amp; Bottle Templates</div>
              <p className="text-[#64748b] text-xs">Parametric customizable structures</p>
            </div>
            <div className="bg-white/85 border border-slate-200/80 rounded-2xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur-md">
              <div className="text-3xl md:text-5xl font-black text-[#B8956A] mb-1 tracking-tight">Zero</div>
              <div className="text-sm font-bold text-[#09090b] uppercase tracking-wider mb-1">Plugins Required</div>
              <p className="text-[#64748b] text-xs">Runs natively in high-performance WebGL</p>
            </div>
          </div>

          {/* Final CTA Overlay Card */}
          <div className="scene-4-cta-overlay absolute inset-0 flex flex-col items-center justify-center text-center p-6 z-20 pointer-events-auto opacity-0 scale-90">
            <div className="bg-white/95 backdrop-blur-2xl border border-slate-200/90 rounded-3xl p-10 md:p-14 max-w-2xl w-full shadow-[0_25px_70px_rgba(0,0,0,0.12),0_10px_25px_rgba(0,0,0,0.04)] flex flex-col items-center">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#B8956A]/10 border border-[#B8956A]/30 text-[#9A7446] text-xs font-bold mb-4 uppercase tracking-widest">
                ✦ Start Your Packaging Journey
              </span>
              <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4 uppercase leading-tight text-[#09090b]">
